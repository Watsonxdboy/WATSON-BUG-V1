...
GOAT-BUG-CONNECTED SUCCESSFULLY 
...
`.trim()
            ...
            break
            case 'runtime':
                let runtimetext = `Goat-𝙱ug 𝚅2 𝙼𝙳 𝙷𝙰𝚂 𝙱𝙴𝙴𝙽 𝙾𝙽𝙻𝙸𝙽𝙴. 𝙲𝙻𝙸𝙲𝙺 𝚃𝙾 𝙲𝙷𝙴𝙲𝙺 𝙼𝚈 𝚁𝚄𝙽𝚃𝙸𝙼𝙴⬇️👇
		${readmore}
		Goat-Bug v2 Have Been Running For ${runtime(process.uptime())}`
                XeonBotInc.sendMessage(m.chat, {
                    text: runtimetext,
                    contextInfo: {
                        externalAdReply: {
...
•  𝑻𝒉𝒆 𝑳𝒊𝒏𝒌 𝑩𝒆𝒍𝒐𝒘 ⇣⇣.
 ...
 ➨𝑭𝒐𝒓𝒌 𝑨𝒏𝒅 𝑮𝒊𝒗𝒆 𝑨 𝑺𝒕𝒂𝒓 ➻ ❴ https://github.com/Watsonbotinc/Goat-.git ❵
...
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬`,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `SCRIPT OF ${botname} is on Knight md  WhatsApp channel `,
                            thumbnailUrl: 'https://i.ibb.co/Dby2D94/x.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
...
🐞 killer-xd[263**,amount]
🐞 hit263[amount]
🐞 systemcrush[263**,amount]
🐞 xd-boy[263**,amount]
                    ...
                    XeonBotInc.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                title: botname,
                                body: ownername,
                                thumbnailUrl: 'https://telegra.ph/file/b7ae2db82899be94fb9c0.jpg',
                                sourceUrl: link,
                                mediaType: 1,
                                renderLargerThumbnail: true
                            }
